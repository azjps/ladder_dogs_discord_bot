...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('hunt_settings', sa.Column('discord_bot_emoji', sa.TEXT(), autoincrement=False, nullable=True))
    op.add_column('hunt_settings', sa.Column('drive_resources_id', sa.TEXT(), autoincrement=False, nullable=True))
    op.add_column('hunt_settings', sa.Column('discussion_channel', sa.TEXT(), autoincrement=False, nullable=True))
    op.add_column('hunt_settings', sa.Column('archive_delay', sa.INTEGER(), autoincrement=False, nullable=True))
    op.add_column('hunt_settings', sa.Column('discord_bot_channel', sa.TEXT(), autoincrement=False, nullable=True))
    op.add_column('hunt_settings', sa.Column('guild_name', sa.TEXT(), autoincrement=False, nullable=True))
    op.add_column('hunt_settings', sa.Column('discord_use_voice_channels', sa.BIGINT(), autoincrement=False, nullable=True))
    op.add_column('hunt_settings', sa.Column('drive_parent_id', sa.TEXT(), autoincrement=False, nullable=True))
